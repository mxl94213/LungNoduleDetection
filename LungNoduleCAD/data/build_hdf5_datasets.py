...
filenames = X.index.to_series().apply(lambda x: mode+'/image_'+str(x)+'.jpg')
...
build_hdf5_image_dataset(dataset_file, image_shape=(50, 50, 1), mode='file', output_path=output, categorical_labels=True,
